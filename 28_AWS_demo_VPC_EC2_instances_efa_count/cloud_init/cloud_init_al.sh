...
# Add EFA and OpenMPI to PATH and LD_LIBRARY_PATH for ec2-user
...
cat > /home/ec2-user/hostfile << 'EOF'
${hostfile_content}
EOF
chown ec2-user:ec2-user /home/ec2-user/hostfile

echo "========== Create EFA test script"
cat > /home/ec2-user/test_efa.sh << 'SCRIPT'
#!/bin/bash
...
SCRIPT
chown ec2-user:ec2-user /home/ec2-user/test_efa.sh
chmod +x /home/ec2-user/test_efa.sh
