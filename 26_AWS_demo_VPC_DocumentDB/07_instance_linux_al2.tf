...
resource "aws_default_security_group" "demo26_ec2" {
  vpc_id = aws_vpc.demo26.id
  tags   = { Name = "demo26-ec2-sg" }

}


resource "aws_vpc_security_group_ingress_rule" "demo26_ec2_ingress_ssh_0" {
  ...
  tags              = { Name = "demo26_ec2-sgr-ingress-ssh-0" }
}
